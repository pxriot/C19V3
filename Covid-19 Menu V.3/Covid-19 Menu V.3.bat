...
echo                       [32m║ [35m3. Exit         [32m║ [35mCheck [32mGithub [35mFor [32mUpdates
echo                       [32m╚═════════════════╝
echo.
echo.
echo.
...
echo                                            [32m╚════════════════╔══════╝════════════════════════════╚═════╗═════════════════╝ 
echo      000000. Create a Profile                                [32m║                                         ║ 
...
:profile
echo off & cls
title 👑 Create a Profile ~ %computername% ~ Type menu to goto the Prompt 👑
echo.
echo.
echo                      [32mEnter Open Source Info to a text file.
echo           [32mProfile will be saved in a Text File called "CovidProfile.txt"
echo     [32mIf you cannot find the file press the window key and type in "CovidProfile"
echo.
set /p fn=[35mFirst Name: 
set /p mn=[35mMiddle Name: 
set /p ln=[35mLast Name: 
set /p age=[35mAge: 
set /p do=[35mDate of Birth: 
set /p ws=[35mPlace of Work or School: 
set /p state=[35mState: 
set /p zip=[35mZip Code: 
set /p soc=[35mSocial Media Usernames: 
set /p ema=[35mEmails: 
set /p otherrr=[35mOther Information: 
(echo=%fn%) >> CovidProfile.txt
(echo=%mn%) >> CovidProfile.txt
(echo=%ln%) >> CovidProfile.txt
(echo=%age%) >> CovidProfile.txt
(echo=%do%) >> CovidProfile.txt
(echo=%ws%) >> CovidProfile.txt
(echo=%state%) >> CovidProfile.txt
(echo=%zip%) >> CovidProfile.txt
(echo=%soc%) >> CovidProfile.txt
(echo=%ema%) >> CovidProfile.txt
(echo=%otherrr%) >> CovidProfile.txt
echo [32m[+] [35mSaving Profile to "CovidProfile.txt"...
